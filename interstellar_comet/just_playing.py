...
explosion = pygame.image.load("assets/explosion/4.png")
...
while run:
    ...
    if game_states == "playing":
        if explosion_state == "used":
            print(explosion_state)
            explosion_tick = explosion_tick + 1
    ...
    if game_states == "playing":
        WIN.blit(rock_IMG, (rock_X, rock_Y))
        WIN.blit(explosion, (explosion_x, explosion_y))
